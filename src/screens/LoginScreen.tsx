  ...
  return (
    <div className="w-full h-full p-8 flex flex-col animate-in relative overflow-y-auto no-scrollbar">
      <div className="max-w-md w-full mx-auto flex flex-col justify-center min-h-full">
        <button onClick={onBack} className="absolute top-8 left-8 text-gray-400 hover:text-white transition-colors p-3 hover:bg-white/5 rounded-full backdrop-blur-sm border border-transparent hover:border-white/10"><ArrowLeft /></button>
